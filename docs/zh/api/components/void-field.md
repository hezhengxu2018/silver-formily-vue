...
| 属性        | 说明                                                       | 类型                                                                 | 默认值         |
| ----------- | ---------------------------------------------------------- | -------------------------------------------------------------------- | -------------- |
| name        | 节点在 Form 中的路径，必须唯一                             | [FormPathPattern](#FormPathPattern)                                  | —              |
| basePath    | 计算 `name` 时的基路径，适合在数组/嵌套结构中复用          | [FormPathPattern](#FormPathPattern)                                  | 当前上下文路径 |
...
| reactions   | 副作用响应器，支持单个函数或函数数组                       | [FieldReaction](#FieldReaction) \| [FieldReaction](#FieldReaction)[] | —              |
