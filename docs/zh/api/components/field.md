...
| 属性            | 说明                                                                  | 类型                                                                                                         | 默认值         |
| --------------- | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | -------------- |
| name            | 字段在 Form 中的路径，必须唯一                                        | [FormPathPattern](/zh/types/path.html#formpathpattern)                                                       | —              |
| basePath        | 推导 `name` 的基准路径，常用于局部表单或数组项                        | [FormPathPattern](/zh/types/path.html#formpathpattern)                                                       | 当前表单根路径 |
...
| validator       | 自定义校验器，签名与 Formily `validator` 一致（在本库中类型为 `any`） | [FieldValidator](/zh/types/validator.html#fieldvalidator)                                                    | —              |
...
| reactions       | 响应式副作用，支持函数或函数数组                                      | [FieldReaction](/zh/types/field.html#fieldreaction) \| [FieldReaction](/zh/types/field.html#fieldreaction)[] | —              |
